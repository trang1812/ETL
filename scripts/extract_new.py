...
#base_path: returns the pathname to the path passed as a parameter to this function
...
#os.path.dirname: get the directory name from the specified path
#os.makedirs: create a directory recursively. That means while making leaf directory if any intermediate-level directory is missing
